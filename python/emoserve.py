...
sharedObject["dft"]["F3"] = [0] * 32
sharedObject["dft"]["FC5"] = [0] * 32
sharedObject["dft"]["AF3"] = [0] * 32
sharedObject["dft"]["F7"] = [0] * 32
sharedObject["dft"]["T7"] = [0] * 32
sharedObject["dft"]["P7"] = [0] * 32
sharedObject["dft"]["O1"] = [0] * 32
sharedObject["dft"]["O2"] = [0] * 32
sharedObject["dft"]["P8"] = [0] * 32
sharedObject["dft"]["T8"] = [0] * 32
sharedObject["dft"]["F8"] = [0] * 32
sharedObject["dft"]["AF4"] = [0] * 32
sharedObject["dft"]["FC6"] = [0] * 32
sharedObject["dft"]["F4"] = [0] * 32
